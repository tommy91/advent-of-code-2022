"""
Advent of Code 2022
Day 7: No Space Left On Device (Part One)
"""
...
def sum_sizes(tree):
    ...
    for subtree in tree:
        if not type(tree[subtree]) == dict:
            ...
            tree_sum += subtrees_sum
    if tree_size <= max_size:
        tree_sum += tree_size
    return tree_sum, tree_size
...
total_sum, _ = sum_sizes(file_tree)


print(f"Sum of total sizes: {total_sum}")
